 ...
 */
class OrangeIcsLinearLayout extends LinearLayout {
    ...
    public OrangeIcsLinearLayout(Context context, int themeAttr) {
        super(context);

        TypedArray a = context.obtainStyledAttributes(null, LL, themeAttr, 0);
        setDividerDrawable(a.getDrawable(OrangeIcsLinearLayout.LL_DIVIDER));
